...
#define EXPECT_MSG(msg_ptr, expected, actual) sprintf(msg_ptr, "Expected: %d, Actual: %d\n", expected, actual)
...
#define EXPECT_MSG_UNSIGNED(msg_ptr, expected, actual) sprintf(msg_ptr, "Expected: %u, Actual: %u\n", expected, actual)

...
Yoru_TestResult_t test_list_basic(void)
{
    ...
    int *val0 = yoru_list_get(int *, list, 0);
    int *val1 = yoru_list_get(int *, list, 1);
    int *val2 = yoru_list_get(int *, list, 2);
...
Yoru_TestResult_t test_trie_basic(void)
{
    ...
    struct Person *retrieved = trie_get(struct Person *, trie, person.pid);
